...
- **Eventos**: Muestra los eventos importantes relacionados con las actividades académicas.
- **Calificaciones**: Página donde los estudiantes pueden consultar sus calificaciones.
- **Horario de Clases**: Página donde los estudiantes pueden consultar sus horarios de clases.
- **Ramos**: Gestión de los ramos que cursan los estudiantes.
- **Planograma General**: Visión general de las actividades programadas.
